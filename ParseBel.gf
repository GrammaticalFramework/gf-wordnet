...
concrete ParseBel of Parse = 
  ...
  AdjectiveBel - [ReflA2, CAdvAP, AdjOrd],
  AdverbBel - [AdnCAdv, ComparAdvAdj, ComparAdvAdjS],
  SentenceBel - [EmbedVP],
  QuestionBel,
  RelativeBel,
  ConjunctionBel,
  PhraseBel - [UttAP, UttVP],
  NamesBel,
  IdiomBel,
  ConstructionBel - [Language, InLanguage, languageNP, languageCN,
