concrete ParseFao of Parse = 
  NounFao - [PPartNP, UseN2, RelNP, DetNP, NumDigits],
  VerbFao - [PassV2, ReflVP, ComplVV, SlashVV, SlashV2V, SlashV2VNP],
  AdjectiveFao - [ReflA2, CAdvAP, AdjOrd],
  AdverbFao - [ComparAdvAdj, ComparAdvAdjS, AdnCAdv],
  SentenceFao - [EmbedVP],
  RelativeFao,
  QuestionFao,
  ConjunctionFao,
  ...
  NamesFao,
  WordNetFao,
  ConstructionFao - [Language, InLanguage, languageNP, languageCN,
