GF_SOURCES = \
	Parse.gf ParseEng.gf ParsePor.gf ParseSwe.gf ParseSpa.gf ParseBul.gf ParseFin.gf ParseAPI.gf \
	...
	WordNet.gf WordNetEng.gf WordNetSwe.gf WordNetSpa.gf WordNetPor.gf WordNetBul.gf WordNetFin.gf WordNetAPI.gf \
...
Parse.pgf: $(GF_SOURCES) Parse.probs
	gf --make --probs=Parse.probs --gfo-dir=build/gfo ParseBul.gf ParseEng.gf ParseFin.gf ParsePor.gf ParseSpa.gf ParseSwe.gf ParseAPI.gf
