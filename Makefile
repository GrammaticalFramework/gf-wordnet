LANGS = ParseBul ParseCat ParseChi ParseDut ParseEng ParseEst ParseFin ParseGer ParseIta ParseKor ParseMlt ParsePor ParseSlv ParseSpa ParseSwe ParseTha ParseTur ParseAPI
