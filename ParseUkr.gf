concrete ParseUkr of Parse = 
  NounUkr - [PPartNP, UseN2, RelNP, DetNP, NumDigits],
  VerbUkr - [PassV2, ReflVP, ComplVV, SlashVV, SlashV2V, SlashV2VNP],
  AdjectiveUkr - [ReflA2, CAdvAP, AdjOrd],
  AdverbUkr - [AdnCAdv, ComparAdvAdj, ComparAdvAdjS],
  SentenceUkr - [EmbedVP],
  QuestionUkr,
  RelativeUkr,
  ConjunctionUkr,
  PhraseUkr - [UttAP, UttVP],
  NamesUkr,
  IdiomUkr,
  ConstructionUkr - [Language, InLanguage, languageNP, languageCN,
