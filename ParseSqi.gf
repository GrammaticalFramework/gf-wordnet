concrete ParseSqi of Parse = 
  ...
  VerbSqi - [PassV2, ReflVP, ComplVV, SlashVV, SlashV2V, SlashV2VNP],
  AdjectiveSqi - [ReflA2,CAdvAP,AdjOrd],
  AdverbSqi - [ComparAdvAdj, ComparAdvAdjS, AdnCAdv],
  SentenceSqi - [EmbedVP],
  QuestionSqi,
  RelativeSqi,
  ConjunctionSqi,
  PhraseSqi - [UttAP,UttVP],
  IdiomSqi,
  NamesSqi,
  ConstructionSqi - [Language, InLanguage, languageNP, languageCN,
