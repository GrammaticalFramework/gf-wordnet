...
$(SERVER_PATH)/www/SenseService.fcgi: www-services/SenseService.hs www-services/SenseSchema.hs www-services/ContentSchema.hs www-services/PatternMatching.hs www-services/Interval.hs
