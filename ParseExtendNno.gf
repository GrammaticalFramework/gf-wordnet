concrete ParseExtendNno of ParseExtend =
  ExtendNno - [iFem_Pron, youPolFem_Pron, weFem_Pron, youPlFem_Pron, theyFem_Pron, GenNP, DetNPMasc, DetNPFem, FocusAP, ProgrVPSlash, N2VPSlash, A2VPSlash,
...
lin FocusComp comp np = mkClause (comp.s ! np.a) np.a (insertObj (\\_ => np.s ! MorphoNno.nominative) (predV verbBe)) ;
...
lin RecipVPSlash slash = GrammarNno.ComplSlash slash (regNP "varandra" "varandra" Utr Sg);
