...
main = do
  print 1
  gr <- readNGF "/usr/local/share/x86_64-linux-ghc-8.8.4/gf-4.0.0/www/Parse.ngf"
  print 2
...
process gr (l0:l1:l2:l3:l4:l5:ls)
  | take 4 l0 == "abs:"           = trace l0 (l0:(if l1m then l1 else "FIX: "++l1++"\n          "++linearize eng e):(if l2m then l2 else "FIX: "++l2++"\n          "++linearize swe e):(if l3m then l3 else "FIX: "++l3++"\n          "++linearize bul e):l4:l5:process gr ls)
  | take 8 l0 == "abs* Phr"       = trace l0 ((if l1m && l2m && l3m then "DONE: "++l0 else l0):l1:l2:l3:l4:l5:process gr ls)
