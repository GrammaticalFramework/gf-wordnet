...
lin CompoundN n n = mkTerm "CompoundN" n n;
...
lin ExistCN cn = mkTerm "ExistCN" cn;
...
lin NominalizeVPSlashNP vpslash np = mkTerm "NominalizeVPSlashNP" vpslash np;
...
lin ProDrop pron = mkTerm "ProDrop" pron;
...
lin UncontractedNeg = mkTerm "UncontractedNeg";
...
lin UttVPFem ant pol vp = mkTerm "UttVPFem" ant pol vp;
lin UttVPMasc ant pol vp = mkTerm "UttVPMasc" ant pol vp;
lin UttVPS vps = mkTerm "UttVPS" vps;
lin UttVPSFem vps = mkTerm "UttVPSFem" vps;
lin UttVPSMasc vps = mkTerm "UttVPSMasc" vps;
lin UttVPSPl vps = mkTerm "UttVPSPl" vps;
