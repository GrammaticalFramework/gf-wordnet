concrete ParsePes of Parse =
  NounPes - [PPartNP, UseN2, RelNP, DetNP, NumDigits],
  VerbPes - [PassV2, ReflVP, ComplVV, SlashVV, SlashV2V, SlashV2VNP],
  AdjectivePes - [ReflA2, CAdvAP, AdjOrd],
  AdverbPes - [AdnCAdv, ComparAdvAdj, ComparAdvAdjS],
  SentencePes - [EmbedVP],
  QuestionPes,
  RelativePes,
  ConjunctionPes,
  PhrasePes - [UttAP, UttVP],
  IdiomPes,
  TenseX - [Adv, AdN, SC],
  NamesPes,
  ParseExtendPes,
  WordNetPes,
  ConstructionPes - [
    Language, InLanguage, languageNP, languageCN,
