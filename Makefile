LANGS = ParseAfr ParseBul ParseCat ParseChi ParseDut ParseEng ParseEst ParseFin ParseFre ParseGer ParseIta ParseKor ParseMlt ParsePol ParsePor ParseRon ParseSlv ParseSom ParseSpa ParseSwa ParseSwe ParseTha ParseTur ParseAPI
