concrete ParseHye of Parse =
  NounHye - [PPartNP, UseN2, RelNP, DetNP, NumDigits],
  VerbHye - [PassV2, ReflVP, ComplVV, SlashVV, SlashV2V, SlashV2VNP],
  AdjectiveHye - [ReflA2, CAdvAP, AdjOrd],
  AdverbHye - [ComparAdvAdj, ComparAdvAdjS, AdnCAdv],
  SentenceHye - [EmbedVP],
  QuestionHye,
  RelativeHye,
  ConjunctionHye,
  IdiomHye,
  NamesHye,
  ConstructionHye - [Language, InLanguage, languageNP, languageCN,
